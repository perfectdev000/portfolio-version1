...
export default function SkillsText() {
  return (
    <div className="w-full h-full text-base md:text-22 text-gray-500 font-normal">
      ...
      <div className="flex mb-1">✅<div className="pl-1">Expertise of JavaScript UI Frameworks and Libraries such as React, Redux, Next.js, Vue.js, BootStrap</div></div>
      ...
      <div className="flex mb-1">✅<div className="pl-1">In-depth knowledge of RESTful API for Web and Mobile</div></div>
